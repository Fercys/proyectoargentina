<template>
  <base-nav
    ...
    :class="$route.meta.navbarClasses ? $route.meta.navbarClasses : 'bg-white navbar-white'"
    type=""
  >
    <!-- Search form -->
    <form class="navbar-search form-inline mr-sm-3"
          :class="$route.meta.searchClasses ? $route.meta.searchClasses : 'navbar-search-dark'" 
    ...
    <ul class="navbar-nav align-items-center ml-auto ml-md-0">
      <li class="nav-item dropdown">
        <a class="nav-link pr-0" href="javascript:;" @click="logout" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
export default {
  ...
  methods: {
    logout () {
      localStorage.removeItem("es-login")
      this.setSesion(null)
